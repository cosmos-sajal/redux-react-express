...
var _booksAction = __webpack_require__(27);

var _cartAction = __webpack_require__(28);
...
store.dispatch((0, _booksAction.deleteBook)({
	id: 2
}));

store.dispatch((0, _booksAction.updateBook)({
	'id': 1,
	'title': 'updated first book title'
}));

store.dispatch((0, _cartAction.addToCart)({
	id: 100
}));
...
var _booksReducer = __webpack_require__(25);
